...
interface Props {
 ...
 const PAYMENT_METHOD = [
  {
    name:"Thanh toán bằng PayOS",
    value:0
  },
  {
    name:"Thanh toán bằng bằng tiền mặt",
    value:2,
    hide:true
  }
]
...
const getTextMethod = () => {
  const me = PAYMENT_METHOD.find( (i:any) => i.value == method);
  return me ? me?.name :"Vui lòng chọn phương thức thanh toán"
      ...
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <p className="font-medium">Thanh toán bằng coin</p>
          </label>
          <div className={`mt-6 mb-4 space-y-6 ${active ? "block" : "hidden"}`}>
            <div className="text-sm prose dark:prose-invert"></div>
          </div>
        </div>
      </div>
    );
        ...
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <div className="sm:ml-8">
            ...
            <div className="font-semibold mt-1 text-sm">
              <span className="">{getTextMethod()}</span>
            </div>
          </div>
          <button
