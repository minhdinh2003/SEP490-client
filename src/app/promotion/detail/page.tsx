              ...
              <div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Chương trình "Tri ân cuối năm" của Anycar mang đến những ưu
                    đãi hấp dẫn sau: a. Hỗ trợ miễn thường một vụ cho xe làm bảo
                    hiểm sửa chữa sơn gò xe của bạn. b. Quà tặng đặc biệt dành
                    cho khách hàng sử dụng dịch vụ sửa chữa, bảo dưỡng xe và
                    chăm sóc xe mang hóa đơn từ 1.500.000 đồng trở lên. (Không
                    tính hóa đơn từ dịch vụ bảo hiểm) Khách hàng có thể lựa chọn
                    một trong những món quà sau:
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    1. Tẩu sạc nhanh 2. Dây cắm sạc 3. Tinh dầu treo xe 4. Cốc
                    cà phê 5. Giắc cắm đai an toàn 6. Ô gập 7. Tam giác cảnh báo
                    Chương trình "Tri ân cuối năm" nhằm tri ân sự ủng hộ của quý
                    khách hàng và mong muốn mang đến cho bạn những trải nghiệm
                    tốt hơn trong việc duy trì và bảo quản chiếc xe yêu quý của
                    mình."
                  </p>

                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                    Chương trình "Tri ân cuối năm" nhằm tri ân sự ủng hộ của quý khách hàng và mong muốn mang đến cho bạn những trải nghiệm tốt hơn trong việc duy trì và bảo quản chiếc xe yêu quý của mình."
                    </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  consectetur adipiscing elit in voluptate vel
                  </p>
