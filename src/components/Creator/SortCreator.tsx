...
import { Listbox, Popover, Transition } from "@/app/headlessui";
...
const DATA_sortOrderRadios = [
    { name: "Theo tên", id: "Most-Popular" },
    { name: "Theo độ nổi tiếng", id: "Best-Rating" },
    
  ];
const SortOrderCreator: FC<Props> = ({ data = DEMO_DATA, className = "" }) => {
...
export default SortOrderCreator;
