...
const SectionPromo1: FC<SectionPromo1Props> = ({ className = "" }) => {
  return (
    ...
    >
      <div className="relative flex-shrink-0 mb-16 lg:mb-0 lg:mr-10 lg:w-[45%]">
       
        <h2 className="font-semibold text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl mt-6 sm:mt-10 !leading-[1.2] tracking-tight">
         Nạp coin <br /> Tham gia đấu giá
        </h2>
        <span className="block mt-6 text-slate-500 dark:text-slate-400 ">
          Cùng định giá những sản phẩm độc đáo
        </span>
        <div className="flex space-x-2 sm:space-x-5 mt-6 sm:mt-12">
          <ButtonPrimary href="/coin" className="">
           Nạp ngay
          </ButtonPrimary>
          <ButtonSecondary
            href="/auction-list"
